...
results_data <- data.frame(
  question = c("**Origins: where did Yamnaya ancestry come from?**",
    "**Western migration: did people move into Europe?**",
    "**Eastern migration: how far did related populations spread?**",
    "**Culture: did similar objects mean the same people?**",
    "**Lifestyle: how did farming and ancestry change together?**",
    "**Social life: what do kinship and violence reveal?**",
    "**Technology: did horses drive the first expansion?**",
    "**Language: do the results establish what people spoke?**"),
...
results_table <- knitr::kable(
  ...
  format = "pipe",
  align = "l",
  col.names = c("Research question", "Combined finding", "Supporting studies",
                "Limit of the conclusion"),
  caption = "What the ten papers show: Yamnaya origins, migration and regional outcomes"
)
