...
results_data <- data.frame(
  ...
  finding = c("Caucasus–lower Volga-related people moved into the Dnipro–Don region and mixed with local hunter-gatherers before Core Yamnaya formation. Steppe contact with the Balkans occurred by **4711–4450 BCE**, well before the main expansion.",
    ...
    "The migrations provide plausible settings for the spread of some Indo-European languages. The authors also propose Afanasievo–Tocharian and Caucasus–lower Volga proto-Indo-Anatolian connections; the Balkan data constrain a simple steppe route into Anatolia."),
  papers = c("[Lazaridis 2025](https://doi.org/10.1038/s41586-024-08531-5); [Mathieson 2018](https://doi.org/10.1038/nature25778)",
    ...
    "[Haak 2015](https://doi.org/10.1038/nature14317); [Allentoft 2015](https://doi.org/10.1038/nature14507); [Wang 2021](https://doi.org/10.1038/s41586-021-03336-2); [Lazaridis 2025](https://doi.org/10.1038/s41586-024-08531-5); [Mathieson 2018](https://doi.org/10.1038/nature25778)"),
  limit = c("The ancestry models depend on sampled and unsampled proxies and do not uniquely identify the formation centre. Earlier Balkan contact is not the later Yamnaya expansion.",
...
evidence_data <- data.frame(
  study = c("[Haak et al. (2015)](https://doi.org/10.1038/nature14317)",
    ...
    "[Lazaridis et al. (2025)](https://doi.org/10.1038/s41586-024-08531-5)",
  ...
  evidence = c("69 ancient Europeans; DNA marker capture and ancestry models.",
    ...
    "435 ancient individuals: 367 newly reported and 68 with improved data; ancestry modelling, radiocarbon chronology and identity-by-descent analysis.",
  ...
  result = c("German Corded Ware ancestry is about 73% Yamnaya-related, with a retained farmer contribution. Supports substantial westward migration in the early third millennium BCE.",
    ...
    "Caucasus–lower Volga-related people mixed with Dnipro–Don hunter-gatherers to form Serednii Stih groups ancestral to Core Yamnaya; the authors propose a related proto-Indo-Anatolian model.",
  ...
  limitation = c("Small regional groups; Samara Yamnaya may represent a related source rather than the direct migrants.",
    ...
    "The exact Dnipro or Don formation centre remains unresolved; language assignment is inferential and ancestry models depend on proxy populations.",
